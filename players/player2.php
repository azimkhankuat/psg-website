    ...
    <div class="row1">
        <div class="column1">
            <div class="card">
                <?php
                require_once "../db_connection/link.php";
                $sql = "SELECT * FROM players WHERE id='2' ";
        ...
        <div class="column1">
            <div class="card">
                ...
                class player2 extends Player{
                    function player2_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts){
                ...
                $player2 = new player2();
                $player2->player2_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts);
                $player2->same_for_all_players();
                ?>
            </div>
        </div>
    </div>
