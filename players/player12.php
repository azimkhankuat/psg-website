    ...
    <div class="row1">
        <div class="column1">
            <div class="card">
                <?php
                require_once "../db_connection/link.php";
                $sql = "SELECT * FROM players WHERE id='13' ";
        ...
        <div class="column1">
            <div class="card">
                ...
                class player12 extends Player{
                    function player12_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts){
                ...
                $player12->player12_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts);
                $player12->same_for_all_players();
                ?>
            </div>
        </div>
    </div>
