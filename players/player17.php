    ...
    <div class="row1">
        <div class="column1">
            <div class="card">
                <?php
                require_once "../db_connection/link.php";
                $sql = "SELECT * FROM players WHERE id='18' ";
        ...
        <div class="column1">
            <div class="card">
                ...
                class player17 extends Player{
                    function player17_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts){
                ...
                $player17 = new player17();
                $player17->player17_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts);
                $player17->same_for_all_players();
                ?>
            </div>
        </div>
    </div>
