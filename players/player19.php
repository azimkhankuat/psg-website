    ...
    <div class="row1">
        <div class="column1">
            <div class="card">
                <?php
                require_once "../db_connection/link.php";
                $sql = "SELECT * FROM players WHERE id='20' ";
        ...
        <div class="column1">
            <div class="card">
                ...
                class player19 extends Player{
                    function player19_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts){
                ...
                $player19 = new player19();
                $player19->player19_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts);
                $player19->same_for_all_players();
                ?>
            </div>
        </div>
    </div>
