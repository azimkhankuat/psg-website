    ...
    <div class="row1">
        <div class="column1">
            <div class="card">
                <?php
                require_once "../db_connection/link.php";
                $sql = "SELECT * FROM players WHERE id='9' ";
        ...
        <div class="column1">
            <div class="card">
                ...
                class player8 extends Player{
                    function player8_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts){
                ...
                $player8 = new player8();
                $player8->player8_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts);
                $player8->same_for_all_players();
                ?>
            </div>
        </div>
    </div>
