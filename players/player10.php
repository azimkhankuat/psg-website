    ...
    <div class="row1">
        <div class="column1">
            <div class="card">
                <?php
                require_once "../db_connection/link.php";
                $sql = "SELECT * FROM players WHERE id='11' ";
        ...
        <div class="column1">
            <div class="card">
                ...
                class player10 extends Player{
                    function player10_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts){
                ...
                $player10->player10_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts);
                $player10->same_for_all_players();
                ?>
            </div>
        </div>
    </div>
