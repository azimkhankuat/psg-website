    ...
    <div class="row1">
        <div class="column1">
            <div class="card">
                <?php
                require_once "../db_connection/link.php";
                $sql = "SELECT * FROM players WHERE id='22' ";
        ...
        <div class="column1">
            <div class="card">
                ...
                class player21 extends Player{
                    function player21_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts){
                ...
                $player21->player21_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts);
                $player21->same_for_all_players();
                ?>
            </div>
        </div>
    </div>
