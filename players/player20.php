    ...
    <div class="row1">
        <div class="column1">
            <div class="card">
                <?php
                require_once "../db_connection/link.php";
                $sql = "SELECT * FROM players WHERE id='21' ";
        ...
        <div class="column1">
            <div class="card">
                ...
                class player20 extends Player{
                    function player20_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts){
                ...
                $player20 = new player20();
                $player20->player20_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts);
                $player20->same_for_all_players();
                ?>
            </div>
        </div>
    </div>
