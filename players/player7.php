    ...
    <div class="row1">
        <div class="column1">
            <div class="card">
                <?php
                require_once "../db_connection/link.php";
                $sql = "SELECT * FROM players WHERE id='8' ";
        ...
        <div class="column1">
            <div class="card">
                ...
                class player7 extends Player{
                    function player7_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts){
                ...
                $player7 = new player7();
                $player7->player7_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts);
                $player7->same_for_all_players();
                ?>
            </div>
        </div>
    </div>
