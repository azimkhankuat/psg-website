    ...
    <div class="row1">
        <div class="column1">
            <div class="card">
                <?php
                require_once "../db_connection/link.php";
                $sql = "SELECT * FROM players WHERE id='7' ";
        ...
        <div class="column1">
            <div class="card">
                ...
                class player6 extends Player{
                    function player6_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts){
                ...
                $player6 = new player6();
                $player6->player6_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts);
                $player6->same_for_all_players();
                ?>
            </div>
        </div>
    </div>
