    ...
    <div class="row1">
        <div class="column1">
            <div class="card">
                <?php
                require_once "../db_connection/link.php";
                $sql = "SELECT * FROM players WHERE id='4' ";
        ...
        <div class="column1">
            <div class="card">
                ...
                class player3 extends Player{
                    function player3_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts){
                ...
                $player3 = new player3();
                $player3->player3_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts);
                $player3->same_for_all_players();
                ?>
            </div>
        </div>
    </div>
