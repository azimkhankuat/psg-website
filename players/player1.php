        ...
        <div class="column1">
            <div class="card">
                ...
                class player1 extends Player{
                    function player1_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts){
                ...
                $player1 = new player1();
                $player1->player1_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts);
                $player1->same_for_all_players();
                ?>
            </div>
        </div>
    </div>
