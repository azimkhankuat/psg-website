    ...
    <div class="row1">
        <div class="column1">
            <div class="card">
                <?php
                require_once "../db_connection/link.php";
                $sql = "SELECT * FROM players WHERE id='6' ";
        ...
        <div class="column1">
            <div class="card">
                ...
                class player5 extends Player{
                    function player5_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts){
                ...
                $player5 = new player5();
                $player5->player5_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts);
                $player5->same_for_all_players();
                ?>
            </div>
        </div>
    </div>
