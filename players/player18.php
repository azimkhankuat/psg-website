    ...
    <div class="row1">
        <div class="column1">
            <div class="card">
                <?php
                require_once "../db_connection/link.php";
                $sql = "SELECT * FROM players WHERE id='19' ";
        ...
        <div class="column1">
            <div class="card">
                ...
                class player18 extends Player{
                    function player18_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts){
                ...
                $player18 = new player18();
                $player18->player18_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts);
                $player18->same_for_all_players();
                ?>
            </div>
        </div>
    </div>
