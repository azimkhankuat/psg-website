    ...
    <div class="row1">
        ...
        <div class="column1">
            <div class="card">
                ...
                class player14 extends Player{
                    function player14_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts){
                ...
                $player14 = new player14();
                $player14->player14_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts);
                $player14->same_for_all_players();
                ?>
            </div>
        </div>
    </div>
