        ...
        <div class="column1">
            <div class="card">
                ...
                class player4 extends Player{
                    function player4_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts){
                ...
                $player4 = new player4();
                $player4->player4_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts);
                $player4->same_for_all_players();
                ?>
            </div>
        </div>
    </div>
