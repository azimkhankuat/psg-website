    ...
    <div class="row1">
        <div class="column1">
            <div class="card">
                <?php
                require_once "../db_connection/link.php";
                $sql = "SELECT * FROM players WHERE id='14' ";
        ...
        <div class="column1">
            <div class="card">
                ...
                class player13 extends Player{
                    function player13_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts){
                ...
                $player13->player13_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts);
                $player13->same_for_all_players();
                ?>
            </div>
        </div>
    </div>
