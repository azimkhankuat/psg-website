    ...
    <div class="row1">
        <div class="column1">
            <div class="card">
                <?php
                require_once "../db_connection/link.php";
                $sql = "SELECT * FROM players WHERE id='17' ";
        ...
        <div class="column1">
            <div class="card">
                ...
                class player16 extends Player{
                    function player16_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts){
                ...
                $player16 = new player16();
                $player16->player16_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts);
                $player16->same_for_all_players();
                ?>
            </div>
        </div>
    </div>
