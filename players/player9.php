    ...
    <div class="row1">
        <div class="column1">
            <div class="card">
                <?php
                require_once "../db_connection/link.php";
                $sql = "SELECT * FROM players WHERE id='10' ";
        ...
        <div class="column1">
            <div class="card">
                ...
                class player9 extends Player{
                    function player9_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts){
                ...
                $player9 = new player9();
                $player9->player9_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts);
                $player9->same_for_all_players();
                ?>
            </div>
        </div>
    </div>
