    ...
    <div class="row1">
        <div class="column1">
            <div class="card">
                <?php
                require_once "../db_connection/link.php";
                $sql = "SELECT * FROM players WHERE id='12' ";
        ...
        <div class="column1">
            <div class="card">
                ...
                class player11 extends Player{
                    function player11_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts){
                ...
                $player11->player11_info($player_name, $birthdate, $nationality, $profile, $skills, $signed_psg, $games_played, $minutes_played, $starts);
                $player11->same_for_all_players();
                ?>
            </div>
        </div>
    </div>
