    ...
    <div class="admin-content">
        ...
        <div class="content">
            ...
            <form method="post">
                ...
                <div class="form-group">
                    <label for="published_at">New publication date:</label>
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST"){
                ...
                if (isset($_POST['description']) && isset($_POST['url']) && isset($_POST['content']) && isset($_POST['published_at'])){
                    $sql = "UPDATE posts SET description = '$_POST[description]', url = '$_POST[url]', content = '$_POST[content]', published_at = '$_POST[published_at]' WHERE title = '$_POST[title]' ";
                }
